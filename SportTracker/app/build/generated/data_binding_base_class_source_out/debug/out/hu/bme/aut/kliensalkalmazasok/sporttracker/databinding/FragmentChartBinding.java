...
public final class FragmentChartBinding implements ViewBinding {
  ...
  @NonNull
  public final PieChart chartHoliday;

  private FragmentChartBinding(@NonNull LinearLayout rootView, @NonNull PieChart chartHoliday) {
    this.rootView = rootView;
    this.chartHoliday = chartHoliday;
  }
  ...
  public static FragmentChartBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.chartHoliday;
      PieChart chartHoliday = ViewBindings.findChildViewById(rootView, id);
      if (chartHoliday == null) {
        break missingId;
      }

      return new FragmentChartBinding((LinearLayout) rootView, chartHoliday);
    }
